...
(function (Aufgabe2_3) {
    ...
    let kugel1 = { sorte: "Schoko", farbe: "brown", form: canvas.getContext("2d") };
    ...
    let kugel2 = { sorte: "Erdbeere", farbe: "red", form: canvas.getContext("2d") };
    ...
    let kugel3 = { sorte: "Vanille", farbe: "yellow", form: canvas.getContext("2d") };
    ...
    let waffel1 = { farbe: "brown", form: canvas.getContext("2d") };
    ...
    waffel1.form.fill();
    let waffel2 = { farbe: "black", form: canvas.getContext("2d") };
    ...
    let waffel3 = { farbe: "grey", form: canvas.getContext("2d") };
